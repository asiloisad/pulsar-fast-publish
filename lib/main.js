  ...
  activate() {
    ...
    this.disposables.add(
      atom.commands.add(".tree-view .directory", {
        "package-publish:git-major": () => this.publishTreeView("major"),
        "package-publish:git-minor": () => this.publishTreeView("minor"),
        "package-publish:git-patch": () => this.publishTreeView("patch"),
        "package-publish:git-major-if": () => this.publishTreeView("major-if"),
        "package-publish:git-minor-if": () => this.publishTreeView("minor-if"),
        "package-publish:git-patch-if": () => this.publishTreeView("patch-if"),
        "package-publish:ppm-major": () => this.ppmPublishTreeView("major"),
        "package-publish:ppm-minor": () => this.ppmPublishTreeView("minor"),
        "package-publish:ppm-patch": () => this.ppmPublishTreeView("patch"),
        "package-publish:ppm-major-if": () => this.ppmPublishTreeView("major-if"),
        "package-publish:ppm-minor-if": () => this.ppmPublishTreeView("minor-if"),
        "package-publish:ppm-patch-if": () => this.ppmPublishTreeView("patch-if"),
      }),
      atom.commands.add("atom-text-editor:not([mini])", {
        "package-publish:git-major": () => this.publishEditor("major"),
        "package-publish:git-minor": () => this.publishEditor("minor"),
        "package-publish:git-patch": () => this.publishEditor("patch"),
        "package-publish:git-major-if": () => this.publishEditor("major-if"),
        "package-publish:git-minor-if": () => this.publishEditor("minor-if"),
        "package-publish:git-patch-if": () => this.publishEditor("patch-if"),
        "package-publish:ppm-major": () => this.ppmPublishEditor("major"),
        "package-publish:ppm-minor": () => this.ppmPublishEditor("minor"),
        "package-publish:ppm-patch": () => this.ppmPublishEditor("patch"),
        "package-publish:ppm-major-if": () => this.ppmPublishEditor("major-if"),
        "package-publish:ppm-minor-if": () => this.ppmPublishEditor("minor-if"),
        "package-publish:ppm-patch-if": () => this.ppmPublishEditor("patch-if"),
      })
    );
  },
